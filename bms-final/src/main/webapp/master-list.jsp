                            ...
                            <tbody>
                                ...
                                <c:forEach var="bc" items="${listMaster}">
									...
									<tr>
										...
										<td class="text-danger"><c:out value="${bc.connection_status}" /></td>
										<td><c:out value="${bc.fromtime}" /></td>
										<td><c:out value="${bc.totime}" /></td>
										<td><a href="viewPath?tx_id=<c:out value='${bc.transaction_id}' />&card_id=<c:out value='${bc.user_id}' />">Trace Path</a>
